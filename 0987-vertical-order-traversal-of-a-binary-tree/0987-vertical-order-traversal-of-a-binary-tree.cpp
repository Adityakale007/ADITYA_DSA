...
public:
    vector<vector<int>> verticalTraversal(TreeNode* root) {
        ...
        //(horizontal distance , level , nodes vector)
        ...
        while(!q.empty()){
            ...
            //create the mapping
            mp[horizontalDistance][level].push_back(frontNode -> val);
        ...
        for(auto i:mp){
            vector<int> temp;       //for unique horizontal distance
            ...
            ans.push_back(temp);    //for unique horizontal distance
        }
